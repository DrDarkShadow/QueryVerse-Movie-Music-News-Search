...
class UnifiedSearchTasks:
    ...
    def movie_search_task(self, agent, search_criteria, count):
        """Task for searching movies using TMDB API"""
        ...
        return Task(
            ...
            Use the search_tmdb_movies tool with these parameters:
    ...
    def music_search_task(self, agent, search_criteria, count):
        """Task for searching music using iTunes API"""
        # Create a human-readable description of the search criteria
        search_desc = []
        ...
        return Task(
            ...
            Use the search_itunes_music tool with these parameters:
            - search_criteria: {search_criteria}
            - count: {count}
            ...
            - **iTunes Link:** [Listen on iTunes](track_url)
